CREATE DATABASE  IF NOT EXISTS `fbla` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `fbla`;
-- MySQL dump 10.13  Distrib 8.0.33, for Win64 (x86_64)
--
-- Host: localhost    Database: fbla
-- ------------------------------------------------------
...
--
-- Table structure for table `sporting`
--
...
CREATE TABLE `sporting` (
  `sporting_id` int NOT NULL AUTO_INCREMENT,
  `type` varchar(45) NOT NULL,
  PRIMARY KEY (`sporting_id`)
...
-- Dump completed on 2023-07-06 12:24:26
